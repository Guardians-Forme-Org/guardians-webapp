...
- PUT /users/:id — panic("unimplemented") — blocks Edit Profile save
- PUT /circles/:id — panic("unimplemented") — blocks Edit Circle save
- PUT /challenges/:id — panic("unimplemented") returning 400 — blocks Edit Challenge save
- PUT /evidences/:id — frontend wired + placeholder ready; backend building
- Password reset/change — no endpoint; delegate to Supabase built-in (no backend work needed)
