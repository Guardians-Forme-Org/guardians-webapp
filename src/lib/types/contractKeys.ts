...
export const ANCHOR_POINT_KEYS = [
  ...
  "mediaFileReferenceId", "location", "region", "mediaFile", "actionPhoto",
  ...
  "communicationChannel", "boundary", "habitatType", "siteMetadata", "opened",
  ...
  "treeWatered", "treesPlanted", "plantsAdapted", "measurement", "openingHours",
...
export const DATA_ENVELOPE_KEYS = [
  ...
  "outreachMethod", "outreachMethods", "caption", "category", "notes", "name",
